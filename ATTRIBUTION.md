...
**Lizenz:** [Creative Commons Attribution 4.0 International (CC-BY-4.0)](LICENSE)
...
> Schmalnauer, S. (2026). *Objekt-X-Programm — Ein lakatosianisches
> Forschungsjournal zur Riemannschen Hypothese.* Version am jeweiligen
> Commit-Hash. Verfügbar unter <https://github.com/Waschtl904/objekt-x-programm>.

Maschinenlesbare Zitationsdaten stehen in [`CITATION.cff`](CITATION.cff).

## Was dieses Repository behauptet und was nicht

Das Repository dokumentiert **laufende Forschung**. Es enthält
**keinen Beweis der Riemannschen Hypothese**, konstruiert **Objekt X
nicht** und ist **nicht peer-reviewed**. Die Attributionsakte betrifft
...
Die historische Herkunft dieser Praezisierungen und die elf zugeordneten
Dateifassungen sind im [Integritaets-Nachtrag vom 25. September 2026](00-uebersicht/archiv/INTEGRITY_CONTENT_RECONCILIATION_2026-09-25.md)
dokumentiert. Er enthaelt keine pauschale Aussage zum Signaturstatus
heutiger oder kuenftiger Commits.

## Kontakt

Bei Fragen zu Zitation, Weiterverwendung oder mutmaßlicher Übernahme
ohne Attribution ist der GitHub-Issue-Tracker der offizielle Kanal:
<https://github.com/Waschtl904/objekt-x-programm/issues>.

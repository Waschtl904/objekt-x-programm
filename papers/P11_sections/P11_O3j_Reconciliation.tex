...
the former logarithmic gate~\ref{open:log}, stated immediately before this
reconciliation block, is a historical formulation and is resolved positively by
Theorem~\ref{thm:o3k-complement} below.
\end{remark}

\input{P11_sections/P11_O3k_LogComplement_Regularity}
\input{P11_sections/P11_O3l_Polynomial_SecondMoment_Witness}
\input{P11_sections/P11_O3m_PolarGauge_Separation}
\input{P11_sections/P11_O3n_GaugeIntertwining_Criterion}
\input{P11_sections/P11_O3o_TC1_NearNull_Remainder_Collapse}
\input{P11_sections/P11_O3p_Vanishing_NearNull_Core}
\input{P11_sections/P11_O3q_OffDiagonal_NearNull_Block}
\input{P11_sections/P11_O3r_SquareRoot_OffBlock_Witness}
\input{P11_sections/P11_O3s_Relative_Polar_Incompatibility}
\input{P11_sections/P11_O3t_CrossPolar_Defect}
\input{P11_sections/P11_O3u_AngleDefect}
\input{P11_sections/P11_O3v_RankOne_Polar_Drift}
\input{P11_sections/P11_O3w_Uniform_Coercivity_Resolvent_Bridge}
\input{P11_sections/P11_O3x_Resolvent_Jensen_Moments}
\input{P11_sections/P11_O3y_NearNull_Resolvent_Survival}
\input{P11_sections/P11_O3z_Constrained_Gamma_Mosco_Limit}
\input{P11_sections/P11_O3aa_Fixed_Gamma_Crossblock_Normal_Mismatch}
\input{P11_sections/P11_O3ab_Small_Source_Normal_Mismatch}
\input{P11_sections/P11_O3ac_Riesz_Support_Radius}
\input{P11_sections/P11_O3ad_Gamma_Antilocality_Cancellation_Gate}
\input{P11_sections/P11_O3ae_HubOffSupport_Representation}
\input{P11_sections/P11_O3af_Gamma_Symbol_Bridge}
\input{P11_sections/P11_O3ag_Contraction_NoGo_Resolvent_Repair}

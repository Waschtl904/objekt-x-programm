...
\begin{remark}[O3j firewall]\label{rem:o3j-firewall}
The argument proves neither
\[
 E_Ru_h\in\HG^{m_h+3/2}
\]
nor higher logarithmic regularity of the Schur forcing $r_{\sigma,h}$.  The
Dirichlet/log-resolvent bootstrap required by the complement gate remains open.  Also,
$G_{R,T_0}^{-1}$ is not replaced by the global Fourier multiplier

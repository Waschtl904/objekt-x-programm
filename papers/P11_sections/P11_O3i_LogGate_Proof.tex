...
regularity deficit of $m+1$ at this stage of the argument.  This subsection alone does
not decide whether the explicit complement vector constructed below has the additional
regularity.  The question is resolved positively later by
Theorem~\ref{thm:o3k-complement}, which proves a stronger positive Sobolev statement.
Nothing in the present subsection alone proves or disproves strong terminal transport.
\end{remark}
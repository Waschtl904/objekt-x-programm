...
NEU-091--120 einschließlich NEU-120 Patch 2 vom 9. August 2026. Es ist ein
internes SYN-Manuskript; eine Behauptung der Publikationsreife ist damit nicht
verbunden.
\end{abstract}
...
\emph{SYN FINAL AUDITED}, Patch 4 vom 9. August 2026. Die
...
Targeted-Reaudit \texttt{57441d87}. P02 liefert die hier referenzierten
kanonischen Fourier-, Paley--Wiener- und Weilform-Konventionen. P03 wurde nur
für SYN-Stil und Konventionskonsistenz herangezogen; es werden daraus keine
zusätzlichen P07-Aussagen importiert.
\end{remark}

\begin{remark}[LaTeX-SYN-Finalaudit]\label{rem:audit-status}
Der ursprüngliche LaTeX-Transferaudit ist abgeschlossen. Patch 4 ist ein
lokaler SYN-Transfer aus NEU-120 Patch 2 und dem Targeted-Reaudit; er ändert
keine bereits eingefrorene GM-Aussage. Geprüft wurden insbesondere
Formeltranskription, Satzstatus, Typisierung und die Trennung zwischen
notwendiger Bedingung $a_N\to0$ und der weiterhin offenen eigentlichen
Konvergenz. Kein historischer Forschungsknoten wird dadurch zu einer
RH-unabhängigen Konvergenzaussage hochgestuft. Damit bleibt der interne Status
\[

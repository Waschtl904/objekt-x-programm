...
The remaining slice after Theorem~\ref{thm:p12-b2c} is
$e/2 \le R < d/2$ with $\sigma > R$: the two prior open problems
(previous \texttt{open:p12-subwedgeA-fulltail} and part of the
Sub-wedge~A regime not yet closed by the restricted-tail
Theorem~\ref{thm:p12-b2b}).  This section closes it.
...
\begin{theorem}[Full Sub-wedge~A injectivity]\label{thm:p12-b2d}

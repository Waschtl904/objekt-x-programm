...
We claim $y \in C_{19}$ for a.e.\ $x \in W$ (in fact for every $x$;
the boundary point $x = R + \eta$ is a single value of measure zero,
and translation $x \mapsto x - \eta$ preserves null sets in $L^{2}$).
Four inclusions:
\begin{itemize}
...
\[
R < R^{*} \;:=\; d/2 - \eta
\;=\; \tfrac14 \log(3/2) - \tfrac12 \log(256/243)
\;=\; \tfrac14 \log\!\Bigl(\frac{3^{11}}{2^{17}}\Bigr)
\;=\; \tfrac14 \log\!\Bigl(\frac{177147}{131072}\Bigr)
\;\approx\; 0.0753082765.
\]
Combined with $R \ge e/2 \approx 0.0719205$, the problematic
radius interval is
\[
e/2 \le R < R^{*},
...
entire 19-visibility vector at a.e.\ $x$ vanishes; in particular
$l(x) = h(T - x) = 0$ for a.e.\ $x \in (R, \sigma)$.

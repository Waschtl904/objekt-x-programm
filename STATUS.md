...
> Stand: 26. Juli 2026 · letzter Eintrag NEU-224
...
| 5 | `[O-223-2]` | **Typkorrigiert (NEU-223):** $s_k(J^-)$ ist für unbeschränktes $J^-$ nicht definiert. **Voller Raum: `✗[M]` entschieden** (NEU-224) — $\dim\ker D_{\mathrm{rel}}=\infty$ über die Faser $m=1$. Offen nur noch der reduzierte Fall $D_{\mathrm{rel}}\vert_{(\ker D_{\mathrm{rel}})^\perp}$ Alternativ: $\sum_p \operatorname{Tr}\lvert M_p(z)\rvert<\infty$ gleichmäßig auf Kompakta | NEU-56/223 |

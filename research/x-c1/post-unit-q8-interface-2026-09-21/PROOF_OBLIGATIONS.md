...
Status: **OPEN globally**. The first closed chamber `1 <= A <= B <= C <= (log 8)/2` now has an `AUTHOR_DERIVED / EXTERNAL_REVIEW_OPEN` theorem package closing O1-O7 in that scoped chamber; O8-O10 and the unrestricted terminal-horizon programme remain OPEN.

Canonical scoped theorem: [`../first-chamber-raw-td-cocycle-o1-o7-2026-09-22/PROOF.md`](../first-chamber-raw-td-cocycle-o1-o7-2026-09-22/PROOF.md).

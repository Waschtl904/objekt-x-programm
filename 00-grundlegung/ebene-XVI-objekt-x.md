...
| P5.3c | **`✓[M]_neg`:** (51.3)/(51.4)/(51.7) setzen eine Eigenbasis $D_{\mathrm{rel}}\eta_\alpha=\lambda_\alpha\eta_\alpha$ voraus, die nach NEU-225 nicht existiert (verletzt 52.D0). Vor jeder Schattenklassenrechnung auf Spektralmaßform umschreiben | `❓[O]` `[O-226-1]` |

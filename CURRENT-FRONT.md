...
> **Aktuelle Research-Basis:** `main@2102b538c220cd809ad876c425df4f30304eb997` enthält die konsolidierte R37–R43-Linie. Aktive Härtung: Branch `research/r43-gcac-hardening`, mathematischer R43-Head `74a91c71b8b08f60d448811c57ceeca6f6113c87`. Die externe Quellenprüfung bestätigt BD Thm 2.4, Typ-Clock, Zhang Thm 2.6 / MP Thm 3.5 und die Rücknahme der det-normalisierten Überreichweite; wegen fehlendem exakten Review-Head wird daraus keine neue formale `independent GREEN`-Buchung erzeugt. §3G/§3J sind jetzt realisierungsunabhängig formuliert, die PW-det-normalisierte Route ist als nicht anwendbar dokumentiert, und §3K.3 beweist die Analytizität für jedes feste (m\ge1) explizit. **GC-AC bleibt candidate-closed und benötigt Review auf diesem gehärteten Head.** Unter diesem Kandidaten bleibt nur der Normal-Skalar `b_U`; Strong Terminal/C6 bleibt offen.  

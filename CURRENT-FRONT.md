...
> **Aktuelle Research-Basis:** `main@2102b538c220cd809ad876c425df4f30304eb997` enthält die konsolidierte R37–R43-Linie. Aktive Härtung: Branch `research/r43-gcac-hardening`, mathematischer R43-Head `019e4e55e15b4e1df77c15d5b76a992c374d0510`. Der exakte Härtungsreview hat die Bessonov–Denisov-Quellenfassung präzisiert (publizierte Inventiones-Fassung: Inverse-Satz Thm 2.4; separat gepostete Extended-Fassung: Thm 2.5), den Typ-Radius auf den kanonischen generalisierten Inversradius `L_H(Q)` korrigiert und die sesquilineare Riesz-Holomorphie über die reelle symmetrische Form plus komplex-bilineare Komplexifizierung repariert. **GC-AC bleibt candidate-closed, aber nicht unabhängig GREEN; Review des aktuellen exakten Heads steht aus.** Unter diesem Kandidaten ist der letzte Normal-Skalar jetzt reell: `b_U∈[-1,1]`, und Strong Terminal ist exakt äquivalent zu `[b_U Cauchy] & [b_U^2→1]`; `B-TIGHT` ist als iff-uniformes Tail-Kriterium formuliert. Strong Terminal/C6 bleibt offen.  

...
> **Aktuelle Research-Basis:** `main@2102b538c220cd809ad876c425df4f30304eb997` enthält die konsolidierte R37–R43-Linie. Aktive Härtung: Branch `research/r43-gcac-hardening`; aktueller **mathematischer R43-Head** `b0338d78f09017e8a72ece49b7af7514445acd62` (R43-Mathematikblob `d026726a88ed6bbe82f63318541a6d21004600f5`), nachfolgend nur Ledger-/Navigationssync. Die Härtung fixiert die Bessonov–Denisov-Versionsangabe und den generalisierten Inversradius `L_H(Q)`, repariert die Riesz-Analytizität über die reelle symmetrische Form plus komplex-bilineare Komplexifizierung und hält **GC-AC candidate-closed, aber nicht independently GREEN**. Unter diesem Kandidaten ist der letzte Normal-Skalar reell: `b_U∈[-1,1]`; Strong Terminal ist exakt äquivalent zu `[b_U Cauchy] & [b_U^2→1]`. **B-TIGHT** ist das iff-uniforme Tail-Kriterium; in der kanonischen C6a-Jet-ONB ist `1-b_U^2=Σ_{n≥1}|c_{n,U}|^2`, und **B-JMOM** ist ein konkretes ausreichendes gewichtetes Jet-Moment-Gate. Der R27-Strong→Operatornorm-Shortcut ist ausdrücklich ausgeschlossen. B-TIGHT/B-JMOM und die Vorzeichen-/Cauchyfrage bleiben offen; Strong Terminal/C6 bleibt offen.  

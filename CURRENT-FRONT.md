...
> **Aktuelle Research-Basis:** Branch `research/strong-terminal-r37-two-shift-mismatch`; R42-Freeze-Linie bis `f495ce6d89dcb8facc8fa0d4e09dda279b24fb73`, R43 aktuell bis mathematischem Head `b31af535d39bd03d00cb2c1c7d9cec63eed5ea4b`. R43.10n–v sowie der reparierte Analytizitätsblock sind extern bzw. intern belastbar; die Literatur-Schnittstelle wurde source-checked. Der frühere GC-M1-Kandidat ist präzisiert: **skalare Multiplizität eins** ist Kandidat, der verbleibende terminalfreie Dichte-Gate heißt **GC-AC** und fragt nach Ausschluss eines singulär-kontinuierlichen zero-type Radiusanteils. Strong Terminal/C6 bleibt offen; erst nach GC-AC reduziert sich der Rest auf den Normal-Skalar `b_U`.  

...
> **Aktuelle Research-Basis:** `main@2102b538c220cd809ad876c425df4f30304eb997`; aktive Härtung auf `research/r43-gcac-hardening`, mathematischer R43-Head `366c5e3dcdd2b2f16bf8b2663c0284a4db9538f5`, R43-Blob `c843336d43dd13ca31e63f81550d545033a89d7d`. **GC-M1_scalar** bleibt candidate-GREEN; **GC-AC** bleibt candidate-closed. Perplexity meldet auf exakt `c7c6f04cd601ea868cb536327504f6c90b3f0807` / Blob `74a91c71b8b08f60d448811c57ceeca6f6113c87` alle sieben Härtungspunkte destruktiv GREEN; wegen expliziter Wiederverwendung voriger Prüfvektoren ist dies **external destructive GREEN (cross-model nonblind)**, kein formales `independent GREEN (cross-model)`. Neu im aktuellen post-review Kandidaten: expliziter Singularträger-Schritt R43.10cv0–cv2; `b_U∈ℝ`; `Strong Terminal ⇔ [b_U Cauchy] & [b_U^2→1]`; unter B-TIGHT `Strong Terminal ⇔ b_Tb_U→1`; **B-TIGHT/B-JMOM** sowie **B-SIGN/B-ORIENT** bleiben OPEN. Kein Clark-/Randparameter-Import für `b_U` ohne separate Identifikation. R38–R42 bleiben FROZEN — independently verified AI-GREEN ohne kanonische `✓[M]`-Promotion.  
...
| **R43** | OPEN — mixed reviewed/candidate status | Mathematischer Head `2b8cd452d79...`: GC-AC candidate-closed; B-TIGHT-Koeffizienten sind echte C6a-ONB-Koeffizienten; direkter kompakt-resolventer Orbitenergie-Bound ist Primärroute; exakt gleich einer Summenenergie der Projektionen auf die kanonischen Jetkerne `H_S^[m]`. Reproduzierbarer normalized constrained-Gamma Jet-Gram-Test zeigt starke geometrische Konditionierungsdegeneration der §3K-Higher-Jet-Rieszfamilie und kontraindiziert einen globalen uniformen Riesz-Unterrand als Hauptweg, ohne theorem-level No-Go. Kommutator/Gronwall bleibt hinter einem neuen Terminalgenerator-/Differenzierbarkeitssatz gefirewallt. Nach B-TIGHT: B-SIGN über lokalen Inkrement-Gap `<2`, Orbit-Inkrement-Gap oder positive Zwei-Terminal-Korrelation; Darboux nur noch optional bei separatem Regularitätsbeweis. External destructive GREEN (Perplexity, cross-model nonblind) bleibt strikt auf `c7c6f04c...` beschränkt. | `audits/P11_REFEREE_E2E_R43_SINGLE_NORMAL_C6_GATE_2026-09-02.md`; Numerik: `audits/P11_R43_JET_GRAM_CONDITIONING_DIAGNOSTIC_2026-09-03.md`; Review-Synthese: `audits/P11_R43_MULTI_MODEL_REVIEW_7647_JET_GRAM_RECONCILIATION_2026-09-03.md` |

...
| **M1-ND-IMG0** | AI-GREEN candidate + **independent GREEN (certificate, algebraic/mechanical scope)** — keine Promotion | explizite Sheet/Parity-Bildraumcharakterisierung des symmetrischen C2-Covers; 24 formale Slots werden durch \(3_H+3_W\) \(L^2\)-Basisliftkanäle bestimmt; \(P_0\)-Restriktion/Species-Extension beidseitig auf Inputbild; Output-\(P_0\)-Restriktion injektiv auf \(\mathscr R_H^{(4)}\); effektives Affinalphabet: 12 Typen | `audits/P11_R32_SW1_M1_ND_IMAGE_SPACE_CANDIDATE.md`, geprüfter Audit-Blob `4562cdecd76ae12198582ed8c024c6fad66f0814`; `scripts/certify_sw1_m1_nd_image_space.py`, geprüfter Blob `7f5b11bd80e5387b1c5e8d73be4c0e4140eed8d5`; Run `33354246817`, Job `99373257498`, Head `52ae23096d1965ba3eb9c7880471b20ff0c6a5b6`; PR #42, Squash-Merge `d117e4cb6e59a04ac0ae79b8176e4beaf114979e` | legitimiert die \(3\times6\)-Funktionskanalreduktion; **keine Injektivität** |
...
|---|---|---|
| **M1-ND-IMG1 / FINITE-LEVEL CROSS-GRAM INJECTIVITY** | `?[O]` — **einziger aktiver mathematischer Knoten** | Aus M1-FULL auf allen B96-Atomen den exakten \(3\times6\)-Funktionskanal-Ledger von \(\mathscr N_R=R_{P_0}^{\rm out}\widehat{\mathscr C}_R(E_H\oplus E_W)\) assemblieren; danach erst Transfer-/Rekurrenzanalyse und Entscheidung von \(\ker\Gamma_I\). |

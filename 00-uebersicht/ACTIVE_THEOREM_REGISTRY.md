...
| **HT-A4a** | independently GREEN candidate | FG-Klassifikation der sechs Tail-Argumente | dieselbe Datei | allgemeiner Kandidatenhintergrund; HT-A4b-SW1-M benötigt diese Blackbox nicht |
...
| **HT-A4b-SW1-M** | `✓[M]` | derselbe SW1-Scope; sechs direkte Blindwerte plus direkter A-Wall-Spezialfall (genau der Satz aus §12 des Audits) | `audits/P11_R32_HT_A4B_SW1_SELF_CONTAINED_THEOREM_CANDIDATE.md`, gemergt als PR #10 in `main@b06f50f12973e781b87db8b06e54fd590a053b10`; Promotion gebucht in diesem Promotions-PR | vollständig adversarial GREEN geprüft (MECHANICAL, CONSTANTS/ORDERING, SIX-POINT BLINDNESS, A-WALL GEOMETRY, BLACKBOX FIREWALL, PROMOTION SCOPE) und mechanisch gegen den Merge-Commit verifiziert; **nur** der §12-Satz ist promotet — keine globale HT-A4b-Exhaustivität, kein HT-RED, kein A0, keine Schur-Cross-Gram-Injektivität |

Promotionsscope von HT-A4b-SW1-M (exakt, nicht erweitert):
\[
\boxed{
\text{uniforme Membership }(Z,Z,Z,Z,Z,Z)\text{ für }s,a-s,a+s,T-s,2d-s,T+s\text{ auf SW1}
\;+\;
I_b\cap I_-=\emptyset,\ I_b\cap I_+\neq\emptyset\iff\varepsilon>\Delta/2
}
\]

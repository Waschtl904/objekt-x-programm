# U343 — historische Originalquelle

**NOT_CANONICAL / HISTORICAL_SOURCE / INDEPENDENT_REVIEW_PENDING**

Der folgende Quelltext ist ein wort- und bytegetreu eingebetteter historischer Stand. Seine damaligen Aussagen und Autorengegenchecks werden dokumentiert; die Aufnahme erteilt ihnen keine neue mathematische Geltung. Der Prüfcode U543 wird als Text erhalten und nicht in die ausführbaren Skripte oder CI aufgenommen.

- Originalbranch: `r43-full-rest-local-decay-cond-limit`.
- Quellcommit: `112f611727dbd3386bff5e11b9a5d5d143cdee6b`.
- Originalpfad: `audits/P11_R43_FULL_REST_LOCAL_RESOLVENT_DECAY_AND_COND_LIMIT_2026-09-07.md`.
- Quellblob: `3ff0d0d696c9dc455a6fefec14f7856b7ded5f3e`.
- SHA-256 der Originalbytes: `e2685e56e971b33d5ff73a45faf8d640b0f308d9768470429de79738798a48e2`.
- Originalumfang: 24243 Bytes, UTF-8, LF, abschließendes LF.
- [Original im Quellcommit](https://github.com/Waschtl904/objekt-x-programm/blob/112f611727dbd3386bff5e11b9a5d5d143cdee6b/audits/P11_R43_FULL_REST_LOCAL_RESOLVENT_DECAY_AND_COND_LIMIT_2026-09-07.md) · [Einordnung und Grenzen](README.md).

Die zehn Backticks grenzen die Originalbytes ab. Sie gehören ebenso wie dieser Vorspann nicht zum historischen Quellblob. Relative Links innerhalb der Originalquelle beziehen sich auf deren ursprünglichen Repositorypfad und Commit; die Quelle wird hier als Text gezeigt.

...
**COND is tracked separately in:**
- `00-uebersicht/P11_R43_COND_LEDGER_2026-09-04.md`
- `00-uebersicht/P11_R43_B_METINC_COND_FRONT_2026-09-04.md`

## Current GEO/BMIX front
...
For `0<V-U<\log(2)/2`, the frozen martingale cutoff gives an exact dead outer residual layer.  The preferred quantitative BMIX target remains `\|C_{V,U}B_V\|`; support localization alone is not operator-norm smallness.
...
├─ B-METINC-COND [OPEN]
│  └─ see P11_R43_COND_LEDGER_2026-09-04.md
└─ FD23-UNIF [OPEN]
...
with `\|R_VB_V\|=\|B_VR_V^*\|\le1/2`. This is `R43-BMIX-FESHBACH-ABSORPTION ✓[M]` locally; BMIX remains OPEN.
...
Support localization alone does not imply norm smallness.  The separate COND strip-norm audit supplies an independent instance of the same firewall: a vanishing spatial strip can carry order-one or growing `L^2` operator norm after normalization.

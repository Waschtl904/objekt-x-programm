...
**Datum:** 27. Juli 2026  
**Status:** ✓[M]_part  
**Vorgänger:** NEU-228 (`01-primkanten-werkzeuge`)
**Nachfolger:** [O-228-2a1-primary-Wres-computation-of-g0u-and-guv] → NEU-229
**Sperrvermerk:** Keine Schattenklassenrechnung vor Abschluss von [O-228-2a].

> **Hinweis:** Diese Datei wurde ursprünglich irrtümlich in `05-primkanal-fourierladung` abgelegt
> und gehört inhaltlich zu `01-primkanten-werkzeuge` (Hebungsfaser, NEU-153-Abhängigkeit).
...
|---|---|
| **NEU-153** | Hebungsfaser $\mathcal{L}_p$, $\pi_{\mathrm{prim}}$, verbundene Form, Z.179/188/207 |
| NEU-157 | Zulässigkeitsraum $\mathcal{A}_p^{\mathrm{adm}}$, Kernbedingungen |
| NEU-041 | Kopplungsoperator $T_p$, Rohkopplung |
| NEU-221e | Quotientabstieg, Spektralmaßabstieg |
| NEU-228 | Regulatorklassifikation, Hebungswahl (Vorgänger) |
| NEU-229 | Mischblock-Konstruktion (Nachfolger) |
